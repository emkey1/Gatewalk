...
func _init() -> void:
	...
	var shots := [
		["t54_dining", Vector3(0.0, 5.0, -20.0), Vector3(0.0, 6.5, 24.0), Vector3.UP],
		["t54_descent", Vector3(0.0, 12.0, 31.0), Vector3(0.0, 5.0, 16.0), Vector3.UP],
		["t54_overview", Vector3(-8.0, 9.6, -22.0), Vector3(2.0, 4.5, 22.0), Vector3.UP],
	]
	for s in shots:
		cam.position = s[1]
		cam.look_at(s[2], s[3])
