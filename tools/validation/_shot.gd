...
func _init() -> void:
	...
	var shots := [
		["t47_enfilade", Vector3(0.0, 16.35, -66.0), Vector3(0.0, 16.1, 60.0), Vector3.UP],
		["t47_enfwd", Vector3(0.0, 16.35, 60.0), Vector3(0.0, 16.1, -66.0), Vector3.UP],
		["t47_smoking", Vector3(6.0, 16.35, -58.0), Vector3(-6.0, 16.0, -66.0), Vector3.UP],
		["t47_ballroom", Vector3(7.0, 16.35, -22.0), Vector3(-6.0, 16.0, -38.0), Vector3.UP],
	]
	for s in shots:
		cam.position = s[1]
		cam.look_at(s[2], s[3])
